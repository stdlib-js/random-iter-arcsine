...
```javascript
import iterator from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-arcsine@deno/mod.js';
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-iter-arcsine/tags). For example,

```javascript
import iterator from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-iter-arcsine@v0.2.0-deno/mod.js';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-iter-arcsine.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-iter-arcsine

[test-image]: https://github.com/stdlib-js/random-iter-arcsine/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-iter-arcsine/actions/workflows/test.yml?query=branch:v0.2.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-iter-arcsine/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-iter-arcsine?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-iter-arcsine.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-iter-arcsine/main
...
[deno-readme]: https://github.com/stdlib-js/random-iter-arcsine/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-iter-arcsine/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-iter-arcsine/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-iter-arcsine/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-iter-arcsine/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-iter-arcsine/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-iter-arcsine/main/LICENSE
